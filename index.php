...
$book = [
 ...
 echo "Недавно я прочитал книги \"{$book[0]['title']}\" и \"{$book[1]['title']}\",
   написанные соответственно авторами {$book[0]['author']} и {$book[1]['author']}, я осилил в сумме ".
           ($book[0]['pages'] + $book[1]['pages'])." страниц, не ожидал от себя.";
